...
export default function TableView({ partners, onDeleteMany, onEdit, isAdmin }) {
  ...
  selectedIds.length > 0 && selectedIds.length < partners.length;
  ...
  if (isAllSelected) {
    ...
    setSelectedIds(partners.map((u) => u.id));
  }
};
...
const formattedDate = (dateStr) => {
    ...
    const paginatedData = partners.slice(
      (page - 1) * itemsPerPage,
      page * itemsPerPage
    );
  return (
